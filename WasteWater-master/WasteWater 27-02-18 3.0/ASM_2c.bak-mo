within WasteWater;
package ASM_2c "Component models for the Activated Sludge Model No.1"
...
model nitri_constant "ASM1 nitrification tank"
...
model pump "ASM1 wastewater pump"
  ...
  Modelica.Blocks.Interfaces.RealInput u annotation (Placement(transformation(
          extent={{-99,15},{-79,35}})));
  Modelica.Blocks.Interfaces.RealOutput Q annotation (Placement(transformation(extent={{-5,
            103},{5,93}})));
equation
...
"));
  ...
  package Examples
    ...
    class BenchPlant_2b "COST Benchmark WWTP Configuration"
      ...
      WasteWater.ASM_2c.nitri_old tank5(V=1333, Kla=84)
        annotation (Placement(transformation(extent={{-6,-6},{14,14}})));
      WasteWater.ASM_2c.nitri_old tank4(V=1333, Kla=240)
        annotation (Placement(transformation(extent={{-32,-6},{-12,14}})));
      WasteWater.ASM_2c.nitri_old tank3(V=1333, Kla=240)
      ...
      Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
        ...
        tableOnFile=("Inf_dry") <> "NoName") annotation (Placement(transformation(
              extent={{-111,79},{-91,99}})));
      WasteWater.ASM_2c.WWSource wWSource
...
"));
    ...
    class BenchPlant_2c "COST Benchmark WWTP Configuration"
      ...
      WasteWater.ASM_2c.divider2 divider
        annotation (Placement(transformation(extent={{20,-6},{40,14}})));
      WasteWater.ASM_2c.nitri_constant tank5(V=1333)
        annotation (Placement(transformation(extent={{-5,-6},{15,14}})));
      WasteWater.ASM_2c.nitri_variable tank4(V=1333)
        annotation (Placement(transformation(extent={{-31,-6},{-11,14}})));
      WasteWater.ASM_2c.nitri_variable tank3(V=1333)
...
"));
  ...
  package PreClar "Primary clarifier modelling based on ASM1"
    ...
    model preclar1 "Dynamic ASM1 Primary Clarifier Model"
      ...
      Real XCODin;
      Real H;
      ASM_2c.Interfaces.WWFlowAsm1in In
        annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
      ASM_2c.Interfaces.WWFlowAsm1out Out
        annotation (Placement(transformation(extent={{90,-10},{110,10}})));
      ASM_2c.Interfaces.WWFlowAsm1out MeasurePort
...
"));
      ...
      model bottom_layer "Bottom layer of Haertel`s SC model"
        import WWSC = WasteWater.ASM_2c.SecClar.Haertel.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;

        ASM_2c.Interfaces.WWFlowAsm1out PQr
          annotation (Placement(transformation(extent={{-70,-110},{-50,-90}})));
        ASM_2c.Interfaces.WWFlowAsm1out PQw
...
"));
      ...
      model SecClarModKrebs "ASM1 Secondary Settling Tank Model based on Krebs"
        ...
        import WWSC = WasteWater.ASM_2c.SecClar.Krebs.Interfaces;
        extends WWSC.SCVar;
        extends WWSC.ratios;
...
"));
      ...
      model bottom_layer "Bottom layer of Otterpohls`s SC model"
        ...
        import WWSC = WasteWater.ASM_2c.SecClar.Otterpohl.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;
        ASM_2c.Interfaces.WWFlowAsm1out PQr
...
"));
    ...
    package Simple "Simple ASM1 Secondary clarifier model"
      ...
      model SimpleSecClarMod "Simple ASM1 Secondary Clarifier Model"
        ...
        extends WasteWater.ASM_2c.SecClar.Takacs.Interfaces.ratios;
        import SI = Modelica.SIunits;
        package WI = WasteWater.ASM_2c.Interfaces;
        package WWU = WasteWater.WasteWaterUnits;
...
"));
      ...
      model bottom_layer "Bottom layer of Takac`s SC model"
        ...
        import WWSC = WasteWater.ASM_2c.SecClar.Takacs.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;
        ASM_2c.Interfaces.WWFlowAsm1out PQr
...
model nitri_variable "ASM1 nitrification tank"
  // nitrification (aerated) tank, based on the ASM1 model
...
model nitri_old "ASM1 nitrification tank"
  // nitrification (aerated) tank, based on the ASM1 model
