within WasteWater;
package ASM_2d "Component models for the Activated Sludge Model No.1"
...
model nitri_5 "ASM1 nitrification tank"
...
model SecClarModTakacs "Secondary Clarifier ASM1 Model based on Takacs"
  ...
  package WI = WasteWater.ASM_2d.Interfaces;
...
"));
    ...
    class BenchPlant_2d "COST Benchmark WWTP Configuration"
      ...
      WasteWater.ASM_2c.EffluentSink Effluent
        annotation (Placement(transformation(extent={{88,-28},{108,-8}})));
      WasteWater.ASM_2c.SludgeSink WasteSludge
        annotation (Placement(transformation(extent={{87,-51},{107,-31}})));
      WasteWater.ASM_2c.SecClarModTakacs Settler
        annotation (Placement(transformation(extent={{48,-5},{68,15}})));
      WasteWater.ASM_2c.divider2 divider
        annotation (Placement(transformation(extent={{20,-6},{40,14}})));
      WasteWater.ASM_2d.nitri_5 tank5(V=1333)
        annotation (Placement(transformation(extent={{-5,-6},{15,14}})));
      WasteWater.ASM_2d.nitri_34 tank4(V=1333)
        annotation (Placement(transformation(extent={{-31,-6},{-11,14}})));
      WasteWater.ASM_2d.nitri_34 tank3(V=1333)
        annotation (Placement(transformation(extent={{-57,-5},{-37,15}})));
      WasteWater.ASM_2c.deni tank2
        annotation (Placement(transformation(extent={{-48,22},{-28,42}})));
      WasteWater.ASM_2c.deni tank1
        annotation (Placement(transformation(extent={{-76,22},{-56,42}})));
      WasteWater.ASM_2c.mixer3 mixer
        annotation (Placement(transformation(extent={{-104,22},{-84,42}})));
      WasteWater.ASM_2c.sensor_NO sensor_NO
        annotation (Placement(transformation(extent={{-42,48},{-22,68}})));
      WasteWater.ASM_2c.sensor_O2 sensor_O2
        annotation (Placement(transformation(extent={{3,25},{20,42}})));
      Modelica.Blocks.Sources.Constant Qa(k=55338)
        annotation (Placement(transformation(extent={{-75,-65},{-55,-45}})));
      WasteWater.ASM_2c.pump RecyclePump(Q_max=55338) annotation (Placement(
            transformation(
            origin={-84,-12},
            extent={{-10,-10},{10,10}},
            rotation=180)));
      WasteWater.ASM_2c.pump ReturnPump(Q_max=18446) annotation (Placement(
            transformation(
            origin={26,-26},
            extent={{-10,-10},{10,10}},
            rotation=180)));
      WasteWater.ASM_2c.pump WastePump(Q_max=385)
        annotation (Placement(transformation(extent={{59,-55},{79,-35}})));
      Modelica.Blocks.Sources.Constant Qr(k=18446)
        annotation (Placement(transformation(extent={{-10,-10},{10,10}},
            rotation=180,
            origin={67,-81})));
      sensor_NH sensor_NH1 annotation (Placement(transformation(extent={{113,26},
                {129,42}})));
      WasteWater.ASM_2c.sensor_NO sensor_NO1
        annotation (Placement(transformation(extent={{130,27},{146,43}})));
      WasteWater.ASM_2c.sensor_TKN sensor_TKN1
        annotation (Placement(transformation(extent={{166,25},{182,41}})));
      WasteWater.ASM_2c.sensor_COD sensor_COD1
        annotation (Placement(transformation(extent={{148,26},{164,42}})));
      WasteWater.ASM_2c.sensor_TSS sensor_TSS1
      ...
      Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
        ...
        tableOnFile=("Inf_dry") <> "NoName") annotation (Placement(transformation(
              extent={{-111,77},{-91,97}})));
      WasteWater.ASM_2c.WWSource wWSource1
        annotation (Placement(transformation(extent={{-83,77},{-63,97}})));
      WasteWater.ASM_2d.sensor_AE sensor_AE annotation (Placement(
            transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={-30,-51})));
      WasteWater.ASM_2d.sensor_PE sensor_PE annotation (Placement(
            transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={-30,-83})));
      WasteWater.ASM_2d.sensor_EQ sensor_EQ
        annotation (Placement(transformation(extent={{89,23},{109,43}})));
    equation
      ...
      connect(tank3.Out, tank4.In) annotation (Line(points={{-37,5},{-31,5},{
              -31,4}}));
      connect(tank3.In, tank2.Out) annotation (Line(points={{-57,5},{-70,5},{
              -70,18},{-18,18},{-18,32},{-28,32}}));
      ...
      connect(WastePump.u, Qr.y) annotation (Line(points={{60.1,-42.5},{46,
              -42.5},{46,-81},{56,-81}},
                                  color={0,0,255}));
      connect(sensor_NH1.In, Settler.Effluent) annotation (Line(points={{121,26},
              {121,10.7},{68.2,10.7}}));
      connect(sensor_NO1.In, Settler.Effluent) annotation (Line(points={{138,27},
              {138,10.7},{68.2,10.7}}));
      connect(sensor_TKN1.In, Settler.Effluent) annotation (Line(points={{174,25},
              {174,10.7},{68.2,10.7}}));
      connect(sensor_COD1.In, Settler.Effluent) annotation (Line(points={{156,26},
              {156,10.7},{68.2,10.7}}));
      connect(Effluent.In, Settler.Effluent) annotation (Line(points={{88,-16},{
              78.5,-16},{78.5,10.7},{68.2,10.7}}));
      connect(Qr.y, ReturnPump.u) annotation (Line(points={{56,-81},{46,-81},{
              46,-28.5},{34.9,-28.5}},
                                    color={0,0,255}));
      connect(tank5.MeasurePort, sensor_O2.In) annotation (Line(points={{10.5,
              8.5},{10.5,25},{11.5,25}}));
      ...
      connect(tank4.T, tank2.T) annotation (Line(
          points={{-31,8},{-37,8},{-37,15},{-6,15},{-6,72},{-51,72},{-51,36},{
              -48,36}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(tank3.T, tank2.T) annotation (Line(
          points={{-57,9},{-63,9},{-63,15},{-6,15},{-6,72},{-51,72},{-51,36},{
              -48,36}},
          color={0,0,127},
          smooth=Smooth.None));
      ...
      connect(sensor_AE.Kla3, tank3.Kla) annotation (Line(
          points={{-32,-41},{-40,-41},{-40,-4.8},{-47,-4.8}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(sensor_AE.Kla4, tank4.Kla) annotation (Line(
          points={{-30,-41},{-30,-5.8},{-21,-5.8}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(sensor_AE.Kla5, tank5.Kla) annotation (Line(
          points={{-28,-41},{-15,-41},{-15,-5.8},{5,-5.8}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(sensor_PE.Qa, RecyclePump.Q) annotation (Line(
          points={{-32,-73},{-84,-73},{-84,-21.8}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(sensor_PE.Qr, ReturnPump.Q) annotation (Line(
          points={{-30,-73},{-30,-67},{26,-67},{26,-35.8}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(sensor_PE.Qw, WastePump.Q) annotation (Line(
          points={{-28,-73},{42,-73},{42,-35.2},{69,-35.2}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(sensor_EQ.In, Settler.Effluent) annotation (Line(
          points={{99,25},{99,10.7},{68.2,10.7}},
          color={0,0,255},
          smooth=Smooth.None));
      annotation (
        Diagram(coordinateSystem(
            preserveAspectRatio=false,
            extent={{-120,-100},{200,105}},
            grid={1,1}), graphics),
...
"));
  ...
  package PreClar "Primary clarifier modelling based on ASM1"
    ...
    model preclar1 "Dynamic ASM1 Primary Clarifier Model"
      ...
      Real XCODin;
      Real H;
      ASM_2d.Interfaces.WWFlowAsm1in In
        annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
      ASM_2d.Interfaces.WWFlowAsm1out Out
        annotation (Placement(transformation(extent={{90,-10},{110,10}})));
      ASM_2d.Interfaces.WWFlowAsm1out MeasurePort
...
"));
      ...
      model SecClarModHaertel
        ...
        package SCP = Haertel;
        import SI = Modelica.SIunits;
        package WI = WasteWater.ASM_2c.Interfaces;
        package WWU = WasteWater.WasteWaterUnits;
        parameter SI.Length hsc=4.0 "height of secondary clarifier";
        parameter Integer n=10 "number of layers of SC model";
        parameter SI.Length zm=hsc/(1.0*n)
...
"));
      ...
      model bottom_layer "Bottom layer of Haertel`s SC model"
        import WWSC = WasteWater.ASM_2d.SecClar.Haertel.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;

        ASM_2d.Interfaces.WWFlowAsm1out PQr
          annotation (Placement(transformation(extent={{-70,-110},{-50,-90}})));
        ASM_2d.Interfaces.WWFlowAsm1out PQw
...
"));
      ...
      model SecClarModKrebs "ASM1 Secondary Settling Tank Model based on Krebs"
        ...
        import WWSC = WasteWater.ASM_2d.SecClar.Krebs.Interfaces;
        extends WWSC.SCVar;
        extends WWSC.ratios;
...
"));
      ...
      model bottom_layer "Bottom layer of Otterpohls`s SC model"
        ...
        import WWSC = WasteWater.ASM_2d.SecClar.Otterpohl.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;
        ASM_2d.Interfaces.WWFlowAsm1out PQr
...
"));
    ...
    package Simple "Simple ASM1 Secondary clarifier model"
      ...
      model SimpleSecClarMod "Simple ASM1 Secondary Clarifier Model"
        ...
        extends WasteWater.ASM_2d.SecClar.Takacs.Interfaces.ratios;
        import SI = Modelica.SIunits;
        package WI = WasteWater.ASM_2d.Interfaces;
        package WWU = WasteWater.WasteWaterUnits;
...
"));
      ...
      model bottom_layer "Bottom layer of Takac`s SC model"
        ...
        import WWSC = WasteWater.ASM_2d.SecClar.Takacs.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;
        ASM_2d.Interfaces.WWFlowAsm1out PQr
...
model sensor_EQ
  ...
  extends WasteWater.Icons.sensor_Q;
  Interfaces.WWFlowAsm1in In annotation (Placement(transformation(extent={{-10,-70},{10,-90}})));
...
equation
  ...
  der(EQ) = 1/(T*1000)*(2 * SSe + 1 * CODe + 30 * Snkj + 10 * In.Sno + 2 * BODe) * In.Q;
