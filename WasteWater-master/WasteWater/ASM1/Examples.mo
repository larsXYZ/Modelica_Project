...
package Examples "Demonstration examples of the components of the ASM1 library"
  ...
  class SmallPlant "Small WWTP Configuration"
    ...
    ASM1.nitri tank3(V=1333) annotation (Placement(transformation(extent={{-6,
              -6},{14,14}})));
    ASM1.nitri tank2(V=1333) annotation (Placement(transformation(extent={{-33,-6},
              {-13,14}})));
    ...
    WasteWater.ASM1.sensor_TSS sensor_TSS1 annotation (Placement(transformation(
            extent={{32,14},{49,30}})));
    ASM1.deni tank4(V=3000) annotation (Placement(transformation(extent={{-45,21},
              {-25,41}})));
    ASM1.deni tank5(V=3000) annotation (Placement(transformation(extent={{-75,21},
              {-55,41}})));
    ASM1.nitri tank1(V=1333) annotation (Placement(transformation(extent={{-63,-6},
              {-43,14}})));
    WasteWater.ASM1.SecClarModTakacs secClarModTakacs
      annotation (Placement(transformation(extent={{46,-5},{66,15}})));
  equation
    ...
    connect(tank5.In, mixer.Out) annotation (Line(
        points={{-75,31},{-79,31},{-79,31.6},{-84,31.6}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(tank4.In, tank5.Out) annotation (Line(
        points={{-45,31},{-55,31}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(tank1.Out, tank2.In) annotation (Line(
        ...
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank4.Out, tank1.In) annotation (Line(
        points={{-25,31},{-13,31},{-13,16},{-76,16},{-76,4},{-63,4}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(divider.Out1, secClarModTakacs.Feed) annotation (Line(
        points={{40,6.6},{47.5,6.6},{47.5,6.4},{46,6.4}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(secClarModTakacs.Return, ReturnPump.In) annotation (Line(
        points={{53,-4.6},{52,-4.6},{52,-22.7},{36,-22.7}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(secClarModTakacs.Waste, WastePump.In) annotation (Line(
        points={{59,-4.6},{59,-23},{55,-23},{55,-48.3},{59,-48.3}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(secClarModTakacs.Effluent, sensor_TKN1.In) annotation (Line(
        points={{66.2,10.7},{85,10.7},{85,11},{100,11},{100,14},{105,14}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(sensor_NH1.In, sensor_TKN1.In) annotation (Line(
        points={{72,15},{72,11},{85,10.7},{85,11},{100,11},{100,14},{105,14}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_NO1.In, sensor_TKN1.In) annotation (Line(
        points={{89,15},{89,11},{100,11},{100,14},{105,14}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(sensor_COD1.In, sensor_TKN1.In) annotation (Line(
        points={{105,-5},{95,-5},{95,10},{96,10},{96,14},{105,14}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(Effluent.In, sensor_TKN1.In) annotation (Line(
        points={{88,-16},{82,-16},{82,11},{76,11},{85,10.7},{85,11},{100,11},{
            100,14},{105,14}},
        color={0,0,255},
        smooth=Smooth.None));
    annotation (
